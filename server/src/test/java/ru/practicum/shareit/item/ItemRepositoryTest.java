...
@DataJpaTest
public class ItemRepositoryTest { // ИНТЕГРАЦИОННЫЙ ТЕСТ ДЛЯ БАЗЫ ДАННЫХ
    // Этот класс тестов с помощью аннотации @DataJpaTest нужен если в классе есть @Query метод
    @Autowired    // Этот класс тестов опять же как формальность так как я все равно вызываю методы репозитория в service классе тестов
